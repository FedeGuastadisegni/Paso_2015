...
/*----------------------------------------------------------------------------*/
PtrNodoLista crearNodoLista(PtrDato dato) {
...
/*----------------------------------------------------------------------------*/
PtrNodoLista adicionarPrincipio(Lista &lista, PtrDato dato) {
...
/*----------------------------------------------------------------------------*/
/*----------------------------------------------------------------------------*/
PtrNodoLista localizarDato(Lista &lista, PtrDato dato) {
  ...
  while ((ptrCursor != fin()) && (! encontrado)) {
    ...
    if (lista.compara(datoCursor,dato) == IGUAL)
      encontrado = true;
    else
      ptrCursor = siguiente(lista,ptrCursor);
  }
...
/*----------------------------------------------------------------------------*/
/*void eliminarDato(Lista &lista, PtrDato dato) {
...
*/
/*----------------------------------------------------------------------------*/
PtrNodoLista insertarDato(Lista &lista, PtrDato dato) {
...
void reordenar(Lista &lista) {
     ...
     int aux;
     PtrDato auxDato;
     while(siguiente(lista,actual)!=NULL){
          sig=siguiente(lista,actual);
          while(sig!=NULL){
                aux = lista.compara(actual->dato,sig->dato);
                if(aux==MAYOR){
                   auxDato=actual->dato;
                   actual->dato=sig->dato;
                   sig->dato=auxDato;
                }
                sig=siguiente(lista,sig);
          }
     actual=siguiente(lista,actual);
     sig=siguiente(lista,actual);
     }
}
